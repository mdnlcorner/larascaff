                ...
                config.imageEditEditor = {
                    open: async (imageToEdit: any) => {
                        if (config.imageEditor) {
                            ...
                            cropperWrapper.className = 'fixed inset-0 z-[9999] w-full h-screen p-2 sm:p-10 md:p-20 cropper-wrapper dark:bg-dark-900/30'
                            ...
                            window['cropImage'] = () => {
                                cropper.getCroppedCanvas({
                                    ...
                                    pond.removeFile(pond.getFiles().find((uploaded) => {
