...
>
    ...
    <div x-ref="datepicker" class="flex">
        <div class="w-full form-wrapper">
            <input {{ $attr }} placeholder="{{ $placeholder1 }}" value="{{ $value1 }}" readonly data-input-name="{{ $name1 }}" name="{{ $name1 }}"
        ...
        <div class="w-full form-wrapper">
            <input {{ $attr }} placeholder="{{ $placeholder2 }}" readonly value="{{ $value2 }}" data-input-name="{{ $name2 }}" name="{{ $name2 }}"
